    ...
    >
      <div className=" relative py-6">
        <AlignJustify
          ...
          className={`h-6 ${isOpen ? "right-2 top-3" : "-right-1 top-3"
        ...
        <nav aria-label="Main Nav" className="mt-8 flex flex-col space-y-1">
          <details className="group [&_summary::-webkit-details-marker]:hidden">
            <summary
              className={`flex cursor-pointer items-center rounded-lg ${isOpen
            ...
            {authState.role === "admin" && isOpen && (
              <nav aria-label="Teams Nav" className="mt-1 flex flex-col px-4">
                <Link
                  ...
                  className={`flex items-center gap-2 rounded-lg px-4 py-2 text-gray-500  hover:bg-gray-100 hover:text-gray-700 ${path == "/dashboard/feedback-forms" && "bg-gray-100"
                    }`}
                >
      ...
      <div className="sticky inset-x-0 bottom-0 border-t border-gray-100">
        <div
          className={`flex items-center justify-center gap-2  ${isOpen ? "px-4 hover:bg-gray-100" : ""
            }  bg-white  py-6`}
        >
